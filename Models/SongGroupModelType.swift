...
struct BookSongGroup: SongGroupModelType {
    var emptyTableview: (title: String, message: String) { return ("You have not any song book", "A new book can be added by + button on the left corner") }
...
struct CategorySongGroup: SongGroupModelType {
    var emptyTableview: (title: String, message: String) { return ("You have not any category", "A new category can be added by + button on the left corner") }
